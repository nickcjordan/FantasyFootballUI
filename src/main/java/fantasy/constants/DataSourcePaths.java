...
public class DataSourcePaths {
	...
	public static final String ECR_FANTASYPROS_URL = "https://www.fantasypros.com/nfl/rankings/ppr-cheatsheets.php";
	
	public static final String ECR_FANTASYPROS_PATH = "src/main/resources/data/master_players.csv";
