<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navvy" aria-expanded="false">
    ...
    <div class="collapse navbar-collapse" id="navvy">
      ...
      <ul class="nav navbar-nav navTop">
        ...
        <li><div class="roundHeader">	<span class="big-badge">Round ${roundNumber}</span>&nbsp;&nbsp;&nbsp;
        												<span class="big-badge">Pick ${pickNumber}</span></div></li>
      </ul>
      
      <!-- Submit form -->
      <form class="navbar-form navbar-right" action="/pickPlayer" method="post">
